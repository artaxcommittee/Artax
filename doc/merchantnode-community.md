Merchantnode Community Vote API
=============================

Artax now supports full decentralized community vote system.

Community Votes go through a series of stages:
* prepare - create a special transaction that destroys coins in order to make a voting proposal (currently 25 XAX)
...
mode:
    'local' for voting directly from a merchantnode
...
alias is an optional parameter with the MN alias you have in your _merchantnode.conf_ file.
