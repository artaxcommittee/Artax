...
In order to support loading of multiple wallets in artax-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is artax.cpp.
...
Changes to artax.cpp
----------------------
artax.cpp is the entry point into artax-qt, and as such, will require some minor modifications to provide hooks for
