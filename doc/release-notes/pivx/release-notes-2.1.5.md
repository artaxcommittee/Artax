...
2. autocombinerewards feature - Automatically combines merchantnode reward once spendable into a single input.
...
6. Multisend now can filter between staking and merchantnode rewards (soon). Also some bugs addressed.
