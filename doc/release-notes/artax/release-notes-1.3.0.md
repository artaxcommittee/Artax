Artax Core version 1.3.0 is now available from:
...
- Updated merchantnode activation and broadcast.
  Merchantnode activation and broadcast to other nodes has been improved, new checks have been added also to merchantnode alive checks.

- Updated RPC merchantnode.
  Wallet locking is handled better on merchantnode aliases and listmerchantnodes now displays the correct example code.

- Fixed merchantnode/budget system for testnet.
...
- Implemented Locked funds on overview.
  Merchantnode collaterals or locked inputs are now shown as "Locked" on the overview page, this improves the balances overview UX.
