...
Intro
-----
Artax (XAX) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Artax utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run artax-qt.exe.

Artax Core is the original Artax client and it builds the backbone of the network.
