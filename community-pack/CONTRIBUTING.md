...
The following applies to code changes to the Artax Core project, and is not to be
confused with overall Artax Network Protocol consensus changes.

Whether a pull request is merged into Artax Core rests with the project merge
...
Patches that change Artax consensus rules are considerably more involved than
...
Where a patch set proposes to change the Artax consensus, it must have been
...
The Dev-committee are the release managers for each Artax Core release.

The manifesto of the Artax Community from inception is to better blockchain technology, further our social cause and to push the boundaries of on-chain storage and scaling. It is important to note that nobody is obligated to contribute to Artax. But the more people that contribute to its codebase, the better for the future of blockchain. Artax is open-source and free. It is not an asset or security but rather a utility blockchain.
