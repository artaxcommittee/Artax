...
#   c) node1 mines 32 blocks, so now node 0 has 500000XAX, node 1 has 4250XAX, node2 has none.
#   d) node0 sends 601 XAX to node2, in two transactions (301 XAX, then 300 XAX).
