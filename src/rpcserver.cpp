...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Artax features */
        {"artax", "merchantnode", &merchantnode, true, true, false},
        {"artax", "listmerchantnodes", &listmerchantnodes, true, true, false},
        {"artax", "getmerchantnodecount", &getmerchantnodecount, true, true, false},
        {"artax", "merchantnodeconnect", &merchantnodeconnect, true, true, false},
        {"artax", "merchantnodecurrent", &merchantnodecurrent, true, true, false},
        {"artax", "merchantnodedebug", &merchantnodedebug, true, true, false},
        {"artax", "startmerchantnode", &startmerchantnode, true, true, false},
        {"artax", "createmerchantnodekey", &createmerchantnodekey, true, true, false},
        {"artax", "getmerchantnodeoutputs", &getmerchantnodeoutputs, true, true, false},
        {"artax", "listmerchantnodeconf", &listmerchantnodeconf, true, true, false},
        {"artax", "getmerchantnodestatus", &getmerchantnodestatus, true, true, false},
        {"artax", "getmerchantnodewinners", &getmerchantnodewinners, true, true, false},
        {"artax", "getmerchantnodescores", &getmerchantnodescores, true, true, false},
        {"artax", "mnbudget", &mnbudget, true, true, false},
        {"artax", "preparebudget", &preparebudget, true, true, false},
        {"artax", "submitbudget", &submitbudget, true, true, false},
        {"artax", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"artax", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"artax", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"artax", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"artax", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"artax", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"artax", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"artax", "checkbudgets", &checkbudgets, true, true, false},
        {"artax", "mnsync", &mnsync, true, true, false},
        {"artax", "spork", &spork, true, true, false},
        {"artax", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"artax", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"artax", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"artax", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"artax", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"artax", "mncommunityvote", &mncommunityvote, true, true, false},
...
{
    return "> artax-cli " + methodname + " " + args + "\n";
}
