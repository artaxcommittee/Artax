...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Artax features */
        {"artax", "masternode", &masternode, true, true, false},
        {"artax", "listmasternodes", &listmasternodes, true, true, false},
        {"artax", "getmasternodecount", &getmasternodecount, true, true, false},
        {"artax", "masternodeconnect", &masternodeconnect, true, true, false},
        {"artax", "masternodecurrent", &masternodecurrent, true, true, false},
        {"artax", "masternodedebug", &masternodedebug, true, true, false},
        {"artax", "startmasternode", &startmasternode, true, true, false},
        {"artax", "createmasternodekey", &createmasternodekey, true, true, false},
        {"artax", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"artax", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"artax", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"artax", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"artax", "getmasternodescores", &getmasternodescores, true, true, false},
