...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("seed1.artaxcoin.org", "seed6.artaxcoin.org"));
        vSeeds.push_back(CDNSSeedData("seed2.artaxcoin.org", "seed3.artaxcoin.org"));
        vSeeds.push_back(CDNSSeedData("seed4.artaxcoin.org", "seed5.artaxcoin.org"));
        
        // Artax addresses start with 'A'
...
public:
    CTestNetParams()
    {
        ...
        // Testnet artax BIP44 coin type is '1' (All coin's testnet default)
