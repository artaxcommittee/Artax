...
//
// CCommunityVote - Allow a merchantnode node to vote and broadcast throughout the network
//
...
public:
    ...
    std::map<uint256, CCommunityProposalBroadcast> mapSeenMerchantnodeCommunityProposals;
    std::map<uint256, CCommunityVote> mapSeenMerchantnodeCommunityVotes;
    std::map<uint256, CCommunityVote> mapOrphanMerchantnodeCommunityVotes;
    ...
    void ClearSeen()
    {
        mapSeenMerchantnodeCommunityProposals.clear();
        mapSeenMerchantnodeCommunityVotes.clear();
    }
    ...
    void Clear()
    {
        ...
        mapSeenMerchantnodeCommunityProposals.clear();
        mapSeenMerchantnodeCommunityVotes.clear();
        mapOrphanMerchantnodeCommunityVotes.clear();
    }
    void CheckAndRemove();
    ...
    inline void SerializationOp(Stream& s, Operation ser_action, int nType, int nVersion)
    {
        READWRITE(mapSeenMerchantnodeCommunityProposals);
        READWRITE(mapSeenMerchantnodeCommunityVotes);
        READWRITE(mapOrphanMerchantnodeCommunityVotes);
...
//
// Community Vote Proposal : Contains the merchantnode votes for each community proposal
//
