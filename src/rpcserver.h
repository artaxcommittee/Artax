...
extern UniValue merchantnode(const UniValue& params, bool fHelp); // in rpcmerchantnode.cpp
extern UniValue listmerchantnodes(const UniValue& params, bool fHelp);
extern UniValue getmerchantnodecount(const UniValue& params, bool fHelp);
extern UniValue merchantnodeconnect(const UniValue& params, bool fHelp);
extern UniValue merchantnodecurrent(const UniValue& params, bool fHelp);
extern UniValue merchantnodedebug(const UniValue& params, bool fHelp);
extern UniValue startmerchantnode(const UniValue& params, bool fHelp);
extern UniValue createmerchantnodekey(const UniValue& params, bool fHelp);
extern UniValue getmerchantnodeoutputs(const UniValue& params, bool fHelp);
extern UniValue listmerchantnodeconf(const UniValue& params, bool fHelp);
extern UniValue getmerchantnodestatus(const UniValue& params, bool fHelp);
extern UniValue getmerchantnodewinners(const UniValue& params, bool fHelp);
extern UniValue getmerchantnodescores(const UniValue& params, bool fHelp);

extern UniValue mnbudget(const UniValue& params, bool fHelp); // in rpcmerchantnode-budget.cpp
...
extern UniValue preparecommunityproposal(const UniValue& params, bool fHelp); // in rpcmerchantnode-vote.cpp
