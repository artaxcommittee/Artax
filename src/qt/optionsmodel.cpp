...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::XAX);
    ...
    if (!settings.contains("fShowMerchantnodesTab"))
        settings.setValue("fShowMerchantnodesTab", merchantnodeConfig.getCount());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in artax.cpp during shotdown to also remove the window positions
...
QVariant OptionsModel::data(const QModelIndex& index, int role) const
{
    if (role == Qt::EditRole) {
        ...
        case ShowMerchantnodesTab:
            return settings.value("fShowMerchantnodesTab");
#endif
...
bool OptionsModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
    ...
    if (role == Qt::EditRole) {
        ...
        case SpendZeroConfChange:
            ...
            break;
        case ShowMerchantnodesTab:
            if (settings.value("fShowMerchantnodesTab") != value) {
                settings.setValue("fShowMerchantnodesTab", value);
                setRestartRequired(true);
            }
            break;
#endif
