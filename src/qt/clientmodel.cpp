...
void ClientModel::updateTimer()
{
    ...
    if (cachedNumBlocks != newNumBlocks ||
        ...
        merchantnodeSync.RequestedMerchantnodeAttempt != prevAttempt || merchantnodeSync.RequestedMerchantnodeAssets != prevAssets) {
        cachedNumBlocks = newNumBlocks;
        cachedReindexing = fReindex;
        cachedImporting = fImporting;
        prevAttempt = merchantnodeSync.RequestedMerchantnodeAttempt;
        prevAssets = merchantnodeSync.RequestedMerchantnodeAssets;
...
void ClientModel::updateMnTimer()
{
    ...
    if (cachedMerchantnodeCountString != newMerchantnodeCountString) {
        ...
        emit strMerchantnodesChanged(cachedMerchantnodeCountString);
    }
}
