...
void OptionsDialog::setModel(OptionsModel* model)
{
    ...
    connect(ui->showMerchantnodesTab, SIGNAL(clicked(bool)), this, SLOT(showRestartWarning()));
}
...
void OptionsDialog::setMapper()
{
    ...
    /* Merchantnode Tab */
    mapper->addMapping(ui->showMerchantnodesTab, OptionsModel::ShowMerchantnodesTab);
}
