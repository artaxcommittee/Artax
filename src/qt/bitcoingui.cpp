...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    if (settings.value("fShowMerchantnodesTab").toBool()) {
        QPixmap merchantnodesIconInactive(":/icons/merchantnodes");
        QPixmap merchantnodesIconActive(":icons/merchantnodes_active");
        QIcon merchantnodesIcon(merchantnodesIconInactive);

        merchantnodesIcon.addPixmap(merchantnodesIconActive,QIcon::Selected,QIcon::On);
        merchantnodesIcon.addPixmap(merchantnodesIconActive,QIcon::Selected,QIcon::Off);
        merchantnodesIcon.addPixmap(merchantnodesIconActive,QIcon::Active,QIcon::On);
        merchantnodesIcon.addPixmap(merchantnodesIconActive,QIcon::Active,QIcon::Off);

        merchantnodeAction = new QAction(merchantnodesIcon, tr("&Merchantnodes"), this);
    ...
    openMNConfEditorAction = new QAction(QIcon(":/icons/edit_black"), tr("Open &Merchantnode Configuration File"), this);
