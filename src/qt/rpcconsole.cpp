...
// Repair parameters
const QString SALVAGEWALLET("-artaxwallet");
                                          ...
                                          cachedNodeid(-1)
{
    ...
    connect(ui->btn_artaxwallet, SIGNAL(clicked()), this, SLOT(walletArtax()));
...
/** Restart wallet with "-artaxwallet" */
void RPCConsole::walletArtax()
{
