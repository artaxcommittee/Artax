...
/** Utility functions used by the Artax Qt UI.
 */
namespace GUIUtil
{
...
// Render XAX addresses in monospace font
...
/**
     ...
     * strings (primarily used in the merchantnode's "active" listing).
     */
