                                          ...
                                          walletModel(0)
{
    ...
    if (settings.value("fShowMerchantnodesTab").toBool()) {
        merchantnodeListPage = new MerchantnodeList();
        addWidget(merchantnodeListPage);
    }
...
void WalletView::setClientModel(ClientModel* clientModel)
{
    ...
    QSettings settings;
    if (settings.value("fShowMerchantnodesTab").toBool()) {
        merchantnodeListPage->setClientModel(clientModel);
    }
}
...
void WalletView::setWalletModel(WalletModel* walletModel)
{
    ...
    QSettings settings;
    if (settings.value("fShowMerchantnodesTab").toBool()) {
        merchantnodeListPage->setWalletModel(walletModel);
    }
...
void WalletView::gotoMerchantnodePage()
{
    QSettings settings;
    if (settings.value("fShowMerchantnodesTab").toBool()) {
        setCurrentWidget(merchantnodeListPage);
    }
}
