...
enum AvailableCoinsType {
    ALL_COINS = 1,
    ONLY_NOT10000IFMN = 3,
    ONLY_10000 = 5,                        // find merchantnode outputs including locked ones (use with caution)
...
public:
    ...
    bool fMultiSendMerchantnodeReward;
    ...
    void SetNull()
    {
        ...
        fMultiSendMerchantnodeReward = false;
    ...
    {
        return fMultiSendMerchantnodeReward || fMultiSendStake;
    }
    ...
    /// Get 1000DASH output and keys which can be used for the Merchantnode
    bool GetMerchantnodeVinAndKeys(CTxIn& txinRet, CPubKey& pubKeyRet, CKey& keyRet, std::string strTxHash = "", std::string strOutputIndex = "");
